/*Esta classe é especial. Não foi criada por nós. Ela é usada para detectar a colisão entre dois objetos.
Estes objetos precisam ser referenciados na chamada da função, bem como o "pai" comum aos dois objetos.
Já que na classe "TelaDeJogo" nós usamos o addChild para adicionar tanto o protagonista como os inimigos,
então podemos escrever "this" como sendo o pai em comum. Um valor Boolean (true/false) também é necessário
para saber se a detecção de colisão deve ou não ser a nível de pixels.*/

/*Esta classe foi criada por Troy Gilbert (http://troygilbert.com/) e está disponível na URL
(http://old.troygilbert.com/2007/06/pixel-perfect-collision-detection-in-actionscript3/). O
criador, por sua vez, tomou como base para esta classe os trabalhos de dois outros programadores,
Andre Michelle e Boulevart. NEHUMA ALTERAÇÃO (NEM MESMO TRADUÇÃO) FOI FEITA POR NÓS NESTA CLASSE*/
